...
(function($) {
	...
	var defaults = {
		...
		view: 'month',
		// Initial date. No matter month, week or day this will be a starting point. Can be 'now' or a date in format 'dd/MM/yyyy'
		day: 'now',
	...
	var strings = {
		...
		error_dateformat: 'Calendar: Wrong date format {0}. Should be either "now" or "dd/MM/yyyy"',
